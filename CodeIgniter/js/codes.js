...
$(document).ready(function() {
  var tabla = $('#asignaturas').DataTable({
          ...
          bootbox.dialog({
            ...
            '<div class="form-group">' +
              '<div class="input-group">' +
                ...
                '</span>' +
                '<input type="text" id="cantidad_alumnos" class="form-control" placeholder="Cantidad alumnos" required>' +
              '</div>' +
            '</div>',
            buttons: {
              cancel: {
    ...
    columns: [
      ...
      {data: 'cantidad_alumnos', title: 'Cantidad Alumnos'},
      {
  ...
  function btnEditarEvent() {
    ...
    cantidad_alumnos = asignatura.cantidad_alumnos
    ;
      ...
      '<div class="form-group">' +
        '<div class="input-group">' +
          '<span class="input-group-addon">' +
            '<i class="glyphicon glyphicon-user"></i>' +
          '</span>' +
          '<input type="text" id="editar_cantidad" class="form-control" value="' + cantidad_alumnos + '" placeholder="Cantidad alumnos">' +
        '</div>' +
      '</div>',
      buttons: {
        cancel: {
          ...
          callback: function(e) {
            ...
            $.ajax({
              ...
              data: {
                ...
                cantidad_alumnos: $('#editar_cantidad').val()
              }
            })
            .fail(function(err) {
